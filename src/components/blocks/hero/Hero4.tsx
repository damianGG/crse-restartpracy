...
import { projectPeriod, projectTitle } from "@/data/project";
        ...
        <div className="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
          ...
          >
            ...
            <figure className="rounded">
              <Image src="/img/photos/women_meet.jpg" width="400" height="300" alt={projectTitle} />
            </figure>
          </div>
          ...
          <div className="col-lg-5 mt-lg-n10 text-center text-lg-start">
            ...
            <p className="lead fs-22 mb-6" style={slideInDownAnimate("900ms")}>
              Okres realizacji: {projectPeriod}
            </p>
            <div className="d-flex justify-content-center justify-content-lg-start gap-2 flex-wrap">
              <span style={slideInDownAnimate("1200ms")}>
                <Link href="/o-projekcie" className="btn btn-lg btn-primary rounded-pill">
                  O projekcie
                </Link>
              </span>
              <span style={slideInDownAnimate("1200ms")}>
                <Link href="/aktualnosci" className="btn btn-lg btn-outline-primary rounded-pill">
                  Aktualności
                </Link>
              </span>
            </div>
